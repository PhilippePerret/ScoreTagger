...
# # OBSOLÈTE :  ON N'ASSEMBLE PLUS. Je garde juste ce script pour voir comment
# #             on assemble des images ensemble, au cas où
#
# =begin
...
#   odd_or_even = 'even'
#
#   current_height = CUTLINES_DATA[0]['height']
#   # add_system_mensurations(1, current_top, current_height)
#   (0...CUTLINES_DATA.count).each do |idx|
#     data_curline = CUTLINES_DATA[idx]
#     add_system_mensurations(idx + 1, current_top, data_curline['height'])
#     data_nexline = CUTLINES_DATA[idx + 1]
